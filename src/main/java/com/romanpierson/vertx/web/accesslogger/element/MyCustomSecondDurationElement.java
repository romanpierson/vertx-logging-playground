...
public class MyCustomSecondDurationElement implements AccessLogElement{
	...
	public Collection<ExtractedPosition> findInRawPatternInternal(final String rawPattern) {
		...
		extractBestPositionFromFixPatternIfApplicable(rawPattern, "%T", () -> new MyCustomSecondDurationElement()).ifPresent(foundPositions::add);
